...
const TYPEWRITER_TEXT = "At Enterprise Scale.";
...
function Corners({ className = "" }: { className?: string }) {
  return (
    <>
      <span className={`absolute top-0 left-0 w-3 h-3 border-t border-l border-[rgba(204,87,51,0.35)] ${className}`} />
      <span className={`absolute top-0 right-0 w-3 h-3 border-t border-r border-[rgba(204,87,51,0.35)] ${className}`} />
      <span className={`absolute bottom-0 left-0 w-3 h-3 border-b border-l border-[rgba(204,87,51,0.35)] ${className}`} />
      <span className={`absolute bottom-0 right-0 w-3 h-3 border-b border-r border-[rgba(204,87,51,0.35)] ${className}`} />
    </>
  );
}
      ...
      <div className="site-container pt-28 pb-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <span style={{ color: "var(--text)" }}>I Build & Ship</span>
              <br />
            ...
            >
              ...
              >
                ...
                <span className="relative">Start a Project Brief</span>
              </a>
            ...
            >
              {[
                ...
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-slate-500 hover:text-[var(--coral)] transition-colors">
                  {s.icon}{s.label}
                </a>
              ))}
            ...
            <div className="card-surface relative rounded-2xl p-5 animate-glow-card overflow-hidden">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium" style={{ color: "var(--coral)" }}>R&D Engineering Lead</p>
                  <p className="text-[var(--text-muted)] text-xs mt-0.5">@ Cegid Enterprise SaaS · 700k+ users</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                {[
                  { v: "Rails", l: "Core Stack" },
                  { v: "8+yr", l: "In Production" },
                  { v: "50+", l: "Systems Shipped" },
                ].map(t => (
